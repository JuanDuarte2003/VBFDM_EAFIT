...
# paths
rcPath='../MadGraph/MG5_aMC_v3_5_1/ppTOy0jj_y0TOxdxd/Cards/run_card.dat'
pcPath='../MadGraph/MG5_aMC_v3_5_1/ppTOy0jj_y0TOxdxd/Cards/param_card.dat'
mlPath='./massList.txt'
binPath='../MadGraph/MG5_aMC_v3_5_1/ppTOy0jj_y0TOxdxd/bin/generate_events'
logPath='../registers/'
...
declare -A couplingDic=(
    [gSxd]="      1 1.000000e+00"
    [gSd11]="      2 0.000000e+00"
    [gSu11]="      3 0.000000e+00"
    [gSd22]="      4 0.000000e+00"
    [gSu22]="      5 0.000000e+00"
    [gSd33]="      6 0.000000e+00"
    [gSu33]="      7 0.000000e+00"
    [Lambda]="      8 1.000000e+04"
    [gSg1]="      9 1.000000e+00"
    [gSg2]="      10 1.000000e+00"
